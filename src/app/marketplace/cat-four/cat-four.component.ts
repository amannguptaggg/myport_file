...
@Component({
  selector: 'app-cat-four',
  templateUrl: './cat-four.component.html',
  styleUrls: ['../market-home/market-home.component.css']
})
export class CatFourComponent implements OnInit {
  public itemsCat:any;
  constructor(private afs:AngularFirestore) { }

  ngOnInit() {
    this.afs.collection('amazon_products',ref=>ref.where("ItemCategory",'==','special-offers')).snapshotChanges().subscribe(
      val=> {
